...
class QuizresultsController extends MyAppController
{
    ...
    public function getQuestions()
    {
        ...
        $db = FatApp::getDb();
        $query = "SELECT * FROM tbl_question_bank WHERE subtopic_id = 16 ORDER BY RAND() LIMIT 15";
            ...
            foreach ($quizzes as $quiz) {
                $formattedQuestions[] = [
                    ...
                    "options" => array_values(array_filter([
                        ...
                        $quiz['answer_c'], 
                        $quiz['answer_d']
                    ])), // Remove null values and reset indexes
