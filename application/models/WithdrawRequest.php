...
class WithdrawRequest extends MyAppModel
{
    ...
    public function sendRequestUpdateEmail(): bool
    {
        ...
        $vars = [
            ...
            '{request_date}' => MyDate::formatDate($data['withdrawal_request_date'], 'Y-m-d H:i:s', $data['user_timezone']),
