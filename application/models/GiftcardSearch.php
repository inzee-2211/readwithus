...
class GiftcardSearch extends YocoachSearch
{
    ...
    public static function getSearchForm(): Form
    {
        ...
        $frm->addSelectBox(Label::getLabel('LBL_Order_Type'), 'order_type', Order::getTypeArr())->requirements()->setIntPositive();
        $frm->addSelectBox(Label::getLabel('LBL_Status'), 'status', Order::getPaymentArr());
