...
class Giftcard extends MyAppModel
{
    ...
    public function sendMailToAdminAndRecipient(int $orderId): bool
    {
        ...
        $srch->addMultipleFields([
            'ordgift_receiver_email', 'ordgift_receiver_name', 'ordgift_code', 'order_net_amount',
            'user.user_first_name', 'user.user_last_name', 'user.user_lang_id'
        ]);
    ...
    public function sendEmailToAdmin(array $giftcard): bool
    {
        ...
        $vars = [
            ...
            '{giftcard_amount}' => $currencyData['currency_symbol_left'] . $giftcard['order_net_amount'] . $currencyData['currency_symbol_right']
        ];
    ...
    public function redeem(string $code, int $userId): bool
    {
        ...
        $comment = Label::getLabel('LBL_GIFTCARD_REDEEM_TO_WALLET_{amount}_BY_GIFT_CODE_{code}');
