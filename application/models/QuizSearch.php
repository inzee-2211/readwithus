...
class QuizSearch extends YocoachSearch
{
    ...
    public static function getListingFields(): array
    {
        return [
            ...
            'quiz.quiz_pass_percentage' => 'quiz_pass_percentage',
            'quiz.quiz_validity' => 'quiz_validity',
            'quiz.quiz_fail_message' => 'quiz_fail_message',
            'quiz.quiz_pass_message' => 'quiz_pass_message',
            'quiz.	quiz_offer_certificate' => '	quiz_offer_certificate',
            'quiz.quiz_status' => 'quiz_status',
            'quiz.quiz_active' => 'quiz_active',
            'quiz.quiz_created' => 'quiz_created',
            // 'quiz.course_slug' => 'course_slug',
            // 'quiz.course_status' => 'course_status',
            // 'quiz.course_active' => 'course_active',
