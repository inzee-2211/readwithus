...
class GoogleCalendarEvent extends MyAppModel
{
    ...
    {
        $title = str_replace(['{teachlang}', '{duration}'], [$lesson['tlang_name'], $lesson['ordles_duration']], Label::getLabel('LBL_{teachlang},_{duration}_MINUTES_OF_LESSON', $lesson['lang_id']));
        $data = [
    ...
    private function eventData(array $data)
    {
        $eventData = [
            ...
            'reminders' => [
                'useDefault' => false,
                'overrides' => [['method' => 'email', 'minutes' => 1440], ['method' => 'email', 'minutes' => 30], ['method' => 'email', 'minutes' => 10]],
            ],
