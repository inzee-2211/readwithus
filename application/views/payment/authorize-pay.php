...
<div class="payment-page">
    <div class="cc-payment">
        <div class="logo-payment">
            ...
            <?php } else { ?>
                <img src="<?php echo MyUtility::makeFullUrl('Image', 'show', [Afile::TYPE_PAYMENT_PAGE_LOGO, 0, Afile::SIZE_LARGE], CONF_WEBROOT_FRONT_URL, null, false, false); ?>" alt="<?php echo FatApp::getConfig('CONF_WEBSITE_NAME_' . $siteLangId) ?>" title="<?php echo FatApp::getConfig('CONF_WEBSITE_NAME_' . $siteLangId) ?>" />
            <?php } ?>
        </div>
        <div class="reff row">
