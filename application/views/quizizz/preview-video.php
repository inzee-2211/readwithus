...
$isSafari = (stripos($userAgent, 'Safari') !== false)
    ...
    && (stripos($userAgent, 'CriOS') === false)   // iOS Chrome
    && (stripos($userAgent, 'FxiOS') === false)   // iOS Firefox
    && (stripos($userAgent, 'EdgiOS') === false)  // iOS Edge
    && (stripos($userAgent, 'OPiOS') === false);  // iOS Opera
