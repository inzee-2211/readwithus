...
$(document).ready(function () {
    ...
    showPreviewVideo = function (courseId) {
        fcom.ajax(fcom.makeUrl('Quizizz', 'previewVideo', [courseId]), '', function (resp) {
            $.facebox(resp);
        });
    };
    toggleCourseFavorite = function (courseId, el) {
        ...
        fcom.updateWithAjax(fcom.makeUrl('Quizizz', 'toggleFavorite', [], confWebDashUrl), data, function (resp) {
            if (status == 0) {
    ...
    reviews = function () {
        ...
        fcom.ajax(fcom.makeUrl('Quizizz', 'reviews'), data, function (resp) {
    ...
    openMedia = function (rsrcId) {
        fcom.ajax(fcom.makeUrl('Quizizz', 'resource', [rsrcId]), '', function (resp) {
