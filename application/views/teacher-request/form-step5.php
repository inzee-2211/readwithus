    ...
    <div class="page-block__body">
        <div class="block-content">
            ...
            <?php } elseif ($request['tereq_status'] == TeacherRequest::STATUS_CANCELLED) { ?>
                ...
                <div class="d-flex justify-content-center">
                    <p><?php echo $request['tereq_comments']; ?></p>
                </div>
                <div class="d-flex justify-content-center">
                    <p><?php echo Label::getLabel('LBL_YOU_CAN_RESUBMIT_APPLICATION'); ?></p>
                </div>
                <?php if ($requestCount < $allowedCount) { ?>
                    <div class="d-flex justify-content-center">
                        <a href="javascript:void(0)" onclick="resubmit();" class="btn btn--bordered btn--small color-secondary"><?php echo Label::getLabel('LBL_Resubmit'); ?></a>
                    </div>
                <?php } ?>
