                            ...
                            <td>
                                <div class="flex-cell">
                                    ...
                                    <div class="flex-cell__content">
                                        ...
                                        ?>
                                            <a href="<?php echo MyUtility::makeFullUrl('Image', 'download', [Afile::TYPE_USER_QUALIFICATION_FILE, $qualificationData['uqualification_id']], CONF_WEBROOT_FRONT_URL); ?>" target="_blank" class="attachment-file">
