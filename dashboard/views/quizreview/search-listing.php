      ...
      // echo '<pre>';print_r($allClasses);die;
        foreach ($allClasses as $question) {
            ...
            <tr>
                ...
                <td>
                    <div class="flex-cell">
                        ...
                        <div class="flex-cell__content">
                            <?php echo $question['user_first_name']; ?>
                    </div>
                </td>
                <td>
                    <div class="flex-cell">
                        ...
                        <div class="flex-cell__content">
                            <?php echo  $question_type= $question['course_title'];
                ...
                <td>
                    <div class="flex-cell">
                        <div class="flex-cell__label"><?php echo 'Number of Re-attempt'; ?></div>
                        <div class="flex-cell__content"><?php echo $question['attempt']; ?></div>
                    </div>
                </td>
                <td>
                    <div class="flex-cell">
                        <div class="flex-cell__label"><?php echo 'Number of Quizzes'; ?></div>
                        <div class="flex-cell__content"><?php echo 1; ?></div>
                    </div>
                </td>
                <td>
                    <div class="flex-cell">
...
?>
                ...
                <td>
                    <div class="flex-cell">
                        ...
                        <div class="flex-cell__content"><?php echo $question['quiz_added_on']; ?></div>
                    </div>
                </td>
                <td>
                    <div class="flex-cell">
                        ...
                        <!-- <a href="javascript:void(0);" onclick="addForm('<?php echo $question['id']; ?>');" class="btn btn--bordered btn--shadow btn--equal margin-1 is-hover">
                    ...
                    <div class="card-landscape__colum card-landscape__colum--second">
                        <div class="card-landscape__head">
                            ...
                            <span class="card-landscape__status badge color-secondary badge--curve badge--small margin-left-0">
                                <?php echo 'sfsfsdf';//$class['statusText']; ?>
                            </span>
