function loadTxt() {
    document.getElementById("tab0").innerHTML = "TEKST";
    document.getElementById("tab1").innerHTML = "SKYGGE";
    document.getElementById("tab2").innerHTML = "AFSNIT";
    document.getElementById("tab3").innerHTML = "LISTE";
    document.getElementById("tab4").innerHTML = "STR.";
