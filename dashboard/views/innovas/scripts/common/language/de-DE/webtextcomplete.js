...
function getTxt(s) {
    switch (s) {
        ...
        case "Preformatted":
            return "Vorformatiert";
        case "Normal":
            return "Normal";
        case "Google Font":
            return "GOOGLE SCHRIFTART:";
    }
}