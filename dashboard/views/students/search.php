            ...
            <tr>
                ...
                <td>
                    <div class="flex-cell">
                        ...
                        <div class="flex-cell__content">
                            <?php
                            $offpri_lesson_price = json_decode(html_entity_decode($student['offpri_lesson_price']) ?? '', true);
                        ...
                        <div class="flex-cell">
                            ...
                            <div class="flex-cell__content">
                                <div class="actions-group">
                                    <a href="javascript:void(0);" onClick="generateThread(<?php echo $student['learner_id']; ?>);" class="btn btn--bordered btn--shadow btn--equal margin-1 is-hover">
