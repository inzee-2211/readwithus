            ...
            <div class="card-landscape">
                <div class="card-landscape__colum card-landscape__colum--first">
                    <div class="card-landscape__head">
                        <time class="card-landscape__time"><?php echo date('H:i', $package['grpcls_starttime_unix']); ?></time>
                        <date class="card-landscape__date"><?php echo $myDate->convertToLocal(date('l, F d, Y', $package['grpcls_starttime_unix'])); ?></date>
                    </div>
                </div>
                    ...
                    <div class="gcard-landscape__body">
                        <div class="detal-list">
                            <div class="detal-list__item">
                                <span class="card-landscape__title"><?php echo $package['grpcls_title']; ?></span>
                            </div>
                            <div class="detal-list__item">
