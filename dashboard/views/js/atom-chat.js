...
var chat_height = '100%';
var chat_width = '100%';
function createCometChatBox(data, chatBoxId) {
    ...
    $(chatBoxId).removeClass('sesson-window__content').addClass('session-window__frame').show();
