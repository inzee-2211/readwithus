...
<div class="table-scroll">
    <table class="table table--styled table--responsive">
        <tr class="title-row">
            ...
            <th><?php echo $totalAmountLabel = Label::getLabel('LBL_TOTAL'); ?></th>
            <th><?php echo $totalDiscountLabel = Label::getLabel('LBL_DISCOUNT'); ?></th>
            <th><?php echo $netAmountLabel = Label::getLabel('LBL_NET_AMOUNT'); ?></th>
            <th><?php echo $paymentMethodLabel = Label::getLabel('LBL_PAY_METHOD'); ?></th>
        ...
        <?php foreach ($orders as $order) { ?>
            <tr class="row-trigger">
                ...
                <td>
                    <div class="flex-cell">
                        <div class="flex-cell__label"><?php echo $totalAmountLabel; ?></div>
                        <div class="flex-cell__content">
                            <div style="max-width: 250px;"><?php echo MyUtility::formatMoney($order['order_total_amount']); ?></div>
                        </div>
                    </div>
                </td>
                <td>
                    <div class="flex-cell">
                        <div class="flex-cell__label"><?php echo $totalDiscountLabel; ?></div>
                        <div class="flex-cell__content">
                            <div style="max-width: 250px;"><?php echo MyUtility::formatMoney($order['order_discount_value']); ?></div>
                        </div>
                    </div>
                </td>
                <td>
                    ...
                    <div class="flex-cell">
                        ...
                        <div class="flex-cell__content">
                            <div style="max-width: 250px;">
                                <?php echo $order['order_pmethod']; ?><br />
                ...
                <td>
                    <div class="flex-cell">
                        ...
                        <div class="flex-cell__content">
                            <span class="badge badge--curve color-<?php echo ($order['order_payment_status'] == Order::ISPAID) ? 'green' : 'yellow'; ?>"><?php echo Order::getPaymentArr($order['order_payment_status']); ?></span>
                        </div>
                    </div>
                </td>
                <td>
                ...
                <td>
                    <div class="flex-cell">
                        ...
                        <div class="flex-cell__content">
                            <div style="max-width: 250px;"><?php echo MyDate::formatDate($order['order_addedon'], 'Y-m-d H:i'); ?></div>
                        </div>
                    </div>
                </td>
                <td>
