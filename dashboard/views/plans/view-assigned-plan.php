            ...
            <div class="content-repeated-container">
                ...
                <div class="content-repeated">
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-8 col-sm-8">
                            <?php echo (!empty($data['plan_detail'])) ? $data['plan_detail'] : Label::getLabel('LBL_NA'); ?>
                        </div>
                    </div>
                </div>
                <br>
                            ...
                            <div class="col-xl-8 col-lg-8 col-sm-8">
                                <?php foreach ($planFiles as $fileRow) { ?>
                                    <span class="badge color-secondary badge--curve">
                                        <a target="_blank" href="<?php echo MyUtility::makeFullUrl('Image', 'downloadById', [$fileRow['file_id']], CONF_WEBROOT_FRONT_URL); ?>">
