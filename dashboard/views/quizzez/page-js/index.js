...
(function () {
    upcoming = function () {
        fcom.ajax(fcom.makeUrl('Quizzez', 'upcoming'), { pagesize: 1 }, function (t) {
    ...
    searchListing = function (frm) {
        fcom.ajax(fcom.makeUrl('Quizzez', 'search'), fcom.frmData(frm), function (res) {
            $("#listing").html(res);
        });
    };
    getCalendarView = function () {
        fcom.ajax(fcom.makeUrl('Quizzez', 'calendarView'), '', function (response) {
