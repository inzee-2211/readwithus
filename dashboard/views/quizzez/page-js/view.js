...
(function () {
    joinLesson = function (lessonId, joinFromApp) {
        ...
        fcom.ajax(fcom.makeUrl('Quizzez', 'joinMeeting'), data, function (response) {
    ...
    endLesson = function (lessonId) {
        if (confirm(endLessonConfirmMsg)) {
            fcom.ajax(fcom.makeUrl('Quizzez', 'endMeeting'), {lessonId: lessonId}, function (response) {
                reloadPage(3000);
            });
        }
    };
    checkLessonStatus = function (lessonId, status) {
        ...
        statusInterval = setInterval(function () {
            fcom.updateWithAjax(fcom.makeUrl('Quizzez', 'checkLessonStatus', [lessonId]), '', function (res) {
