    ...
    foreach ($arrFields as $key => $val) {
        ...
        switch ($key) {
            ...
            case 'usrtxn_datetime':
                $div->appendElement('plaintext', [], MyDate::formatDate($row['usrtxn_datetime']));
                break;
            case 'usrtxn_type':
            ...
            case 'usrtxn_amount':
                ...
                break;
            case 'usrtxn_comment':
                $div->appendElement('div', array('class' => 'flex-cell__content'), Transaction::formatComments($row[$key]), true);
                break;
            default:
