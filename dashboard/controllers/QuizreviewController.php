...
class QuizreviewController extends DashboardController
{
    ...
    public function search()
    {
       ...
       //  $query = $srch->getQuery(); // Get the built SQL query string
  ...
  //echo '<pre>';print_r( $rows);die;
    ...
    public function addForm()
    {
        ...
        if ($classId > 0) {
           ...
           // $isClassBooked = ($classData['grpcls_booked_seats'] > 0);
             ...
             $classData['course_subcate_id'] = $classData['question_subcat'];
            $form->fill($classData);
    ...
    private function getAddForm(bool $setUnique = false): Form
    {
        ...
        $fld = $form->addTextBox(Label::getLabel('LBL_HINT'), 'grpcls_hint');
