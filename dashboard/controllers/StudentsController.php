...
class StudentsController extends DashboardController
{
    ...
    public function search()
    {
        ...
        $srch->addMultipleFields([
            ...
            'learner.user_id AS learner_id', 'offpri_class_price', 'offpri_lesson_price', 'offpri_learner_id',
            'offpri_lessons', 'offpri_classes', 'offpri_class_price', 'offpri_package_price', 'offpri_lesson_price', 'offpri_id'
        ]);
    ...
    public function offerForm()
    {
        ...
        $userSlots = (new TeachLangPrice(0, $this->siteLangId))->getTeachingSlots($this->siteUserId);
    ...
    {
        if ($userSlots == null) {
            $teachLangPrice = new TeachLangPrice(0, $this->siteLangId);
            $userSlots = $teachLangPrice->getTeachingSlots($this->siteUserId);
        }
