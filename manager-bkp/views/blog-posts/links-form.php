...
$fld_div->fieldWrapper = ['<div class="box--scroller">', '</div>'];
?>
<section class="section">
    <div class="sectionhead">
        <h4><?php echo Label::getLabel('LBL_Link_Blog_Post_To_Categories'); ?></h4>
    </div>
            ...
            <div class="col-sm-12">
                <div class="tabs_nav_container responsive flat">
                    <ul class="tabs_nav">
                        ...
                        <li><a class="active" href="javascript:void(0);" onclick="linksForm(<?php echo $post_id ?>);"><?php echo Label::getLabel('LBL_Link_Category'); ?></a></li>
                        <?php
                        if ($post_id > 0) {
