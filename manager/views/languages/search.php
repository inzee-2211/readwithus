        ...
        switch ($key) {
            ...
            case 'action':
                ...
                if ($canEdit) {
                    ...
                    $li->appendElement('a', ['href' => 'javascript:void(0)', 'class' => 'button small green',
                        'title' => Label::getLabel('LBL_Edit'), "onclick" => "editLanguageForm(" . $row['language_id'] . ")"], '<i class="ion-edit icon"></i>',
                            true);
                }
                break;
