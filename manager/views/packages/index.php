...
$srchFrm->setFormTagAttribute('onsubmit', 'searchPackage(this); return(false);');
$srchFrm->setFormTagAttribute('id', 'search');
                ...
                <div class="page__title">
                    <div class="row">
                        <div class="col--first">
                            ...
                            <h5> <?php echo Label::getLabel('LBL_PACKAGE_ORDERS'); ?> </h5>
