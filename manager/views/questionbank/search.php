...
$arr_flds = [
    'id' => Label::getLabel('LBL_ID'),
    'question_title' => Label::getLabel('LBL_TITLE'),
    'answer_a' => Label::getLabel('LBL_OPTION_A'),
    'answer_b' => Label::getLabel('LBL_OPTION_B'),
    'answer_c' => Label::getLabel('LBL_OPTION_C'),
     'answer_d' => Label::getLabel('LBL_OPTION_D'),
     'category' => Label::getLabel('LBL_CATEGORY'),
     'subcategory' => Label::getLabel('LBL_SUBCATEGORY'),
     'topic' => Label::getLabel('LBL_TOPIC'),
     'grade' => Label::getLabel('LBL_GRADE'),
    ...
    foreach ($arr_flds as $key => $val) {
        ...
        switch ($key) {
            case 'action':
                ...
                $innerLiEdit->appendElement('a', ['href' => 'javascript:void(0);', 'onclick' => 'view("'.$row['id'].'")', 'class' => 'button small green', 'title' => Label::getLabel('LBL_DELETE')], Label::getLabel('LBL_DELETE'), true);
              //  $innerLiEdit = $innerUl->appendElement('li');
