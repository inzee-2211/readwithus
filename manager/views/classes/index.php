...
$srchFrm->setFormTagAttribute('onsubmit', 'searchClass(this); return(false);');
$srchFrm->setFormTagAttribute('id', 'frmClassSearch');
                ...
                <div class="page__title">
                    <div class="row">
                        <div class="col--first">
                            ...
                            <h5> <?php echo Label::getLabel('LBL_CLASSES_ORDERS'); ?> </h5>
