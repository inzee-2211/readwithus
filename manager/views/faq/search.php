        ...
        switch ($key) {
            ...
            case 'action':
                ...
                if ($canEdit) {
                    ...
                    $innerLiEdit->appendElement('a', ['href' => 'javascript:void(0)', 'class' => 'button small green', 'title' => Label::getLabel('LBL_Edit'), "onclick" => "editFaqFormNew(" . $row['faq_id'] . ")"], Label::getLabel('LBL_Edit'), true);
                    $innerLiDelete = $innerUl->appendElement("li");
                    $innerLiDelete->appendElement('a', ['href' => 'javascript:void(0)', 'class' => 'button small green', 'title' => Label::getLabel('LBL_Delete'), "onclick" => "deleteRecord(" . $row['faq_id'] . ")"], Label::getLabel('LBL_Delete'), true);
                }
                break;
            default:
...
echo $tbl->getHtml();
$post['page'] = $page;
echo FatUtility::createHiddenFormFromData($post, ['name' => 'frmFaqearchPaging']);
