            ...
            case 'action':
                ...
                if ($canEdit) {
                    ...
                    $innerLiEdit->appendElement('a', ['href' => 'javascript:void(0)', 'class' => 'button small green',
                        'title' => Label::getLabel('LBL_Edit'), "onclick" => "editMetaTagFormNew($metaId,'$metaType',$recordId)"], Label::getLabel('LBL_Edit'),
                            true);
                    if ($metaType == MetaTag::META_GROUP_ADVANCED) {
                        ...
                        $innerLiDelete->appendElement('a', ['href' => 'javascript:void(0)', 'class' => 'button small green',
                            'title' => Label::getLabel('LBL_Delete'), "onclick" => "deleteRecord($metaId)"], Label::getLabel('LBL_Delete'),
                                true);
                    }
                }
                break;
