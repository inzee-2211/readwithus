...
class BlogContributionsController extends AdminBaseController
{
    ...
    private function sendEmail($data)
    {
        ...
        $vars = [
            ...
            '{new_status}' => BlogPost::getContriStatuses($data['bcontributions_status']),
            '{posted_on_datetime}' => $data['bcontributions_added_on'] . " (" . CONF_SERVER_TIMEZONE . " " . MyDate::getOffset(CONF_SERVER_TIMEZONE) . ")",
        ];
        $mail = new FatMailer($this->siteLangId, 'blog_contribution_status_changed');
    ...
    private function getForm($bcontributions_id = 0): Form
    {
        ...
        $frm->addSelectBox(Label::getLabel('LBL_Contribution_Status'), 'bcontributions_status', BlogPost::getContriStatuses(), '', ['class' => 'small'], '');
    ...
    private function getSearchForm(): Form
    {
        ...
        $frm->addSelectBox(Label::getLabel('LBL_Contribution_Status'), 'bcontributions_status', BlogPost::getContriStatuses(), '', ['class' => 'small'], 'Select');
