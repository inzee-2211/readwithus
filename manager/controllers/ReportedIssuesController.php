...
class ReportedIssuesController extends AdminBaseController
{
    ...
    private function getSearchForm(): Form
    {
        ...
        $frm->addSelectBox(Label::getLabel('LBL_Status'), 'repiss_status', Issue::getStatusArr());
        $frm->addTextBox(Label::getLabel('LBL_Order_Id'), 'order_id');
        $frm->addTextBox(Label::getLabel('LBL_CLASS/LESSON_ID'), 'repiss_record_id');
        $frm->addSelectBox(Label::getLabel('LBL_TYPE'), 'repiss_record_type', AppConstant::getClassTypes());
     ...
     * @return Form
     */
    private function getActionForm(bool $isGroupClass = false): Form
    {
        ...
        $frm->addSelectBox(Label::getLabel('LBL_TAKE_ACTION'), 'reislo_action', $options)->requirements()->setRequired();
