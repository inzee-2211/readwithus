...
class PackagesController extends AdminBaseController
{
    ...
    public function search()
    {
        ...
        $srch->addMultipleFields([
            'learner.user_first_name as learner_first_name','order_id',
            'learner.user_last_name as learner_last_name', 'order_net_amount','ordpkg_id',
            'ordpkg_amount', 'ordpkg_discount', 'order_payment_status', 'order_pmethod_id', 'order_addedon'
        ]);
    ...
    public function view()
    {
        ...
        $srch->addMultipleFields([
            'learner.user_first_name as learner_first_name','order_id',
            'learner.user_last_name as learner_last_name', 'order_net_amount','ordpkg_package_id',
            'ordpkg_amount', 'ordpkg_discount', 'order_payment_status', 'order_pmethod_id', 'order_addedon'
        ]);
    ...
    private function getSearchForm(): Form
    {
        ...
        $frm->addSelectBox(Label::getLabel('LBL_STATUS'), 'ordpkg_status', OrderPackage::getStatuses())->requirements()->setIntPositive();
