...
class TestimonialsController extends AdminBaseController
{
    ...
    public function deleteRecord()
    {
        ...
        if (!$testimonialObj->canDelete($testimonial_id)) {
            FatUtility::dieJsonError(Label::getLabel('LBL_INVALID_REQUEST'));
        }
    ...
    private function getForm($testimonialId = 0): Form
    {
        ...
        $frm->addRequiredField(Label::getLabel('LBL_Testimonial_Identifier'), 'testimonial_identifier');
    ...
    private function getLangForm($testimonialId = 0, $lang_id = 0): Form
    {
        ...
        $fld = $frm->addTextarea(Label::getLabel('LBL_Testimonial_Text'), 'testimonial_text');
