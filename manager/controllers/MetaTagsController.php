...
class MetaTagsController extends AdminBaseController
{
    ...
    private function getForm($metaType = MetaTag::META_GROUP_DEFAULT)
    {
        ...
        $frm->addRequiredField(Label::getLabel('LBL_IDENTIFIER'), 'meta_identifier');
    ...
    private function getLangForm(int $metaId = 0, int $langId = 0)
    {
        ...
        $frm->addTextBox(Label::getLabel('LBL_Meta_Title'), 'meta_title');
        $frm->addTextarea(Label::getLabel('LBL_Meta_Keywords'), 'meta_keywords');
        $frm->addTextarea(Label::getLabel('LBL_Meta_Description'), 'meta_description');
        $frm->addTextarea(Label::getLabel('LBL_Other_Meta_Tags'), 'meta_other_meta_tags');
        $frm->addTextBox(Label::getLabel('LBL_Open_Graph_Title'), 'meta_og_title');
        $fld = $frm->addTextBox(Label::getLabel('LBL_Open_Graph_Url'), 'meta_og_url');
        $fld->requirements()->setRegularExpressionToValidate(AppConstant::URL_REGEX);
        $frm->addTextarea(Label::getLabel('LBL_Open_Graph_Description'), 'meta_og_description');
        $fld = $frm->addButton(Label::getLabel("LBL_Open_Graph_Image"), 'open_graph_image', Label::getLabel("LBL_Upload_File"), [
