...
class SlidesController extends AdminBaseController
{
    ...
    public function setupMedia()
    {
        ...
        foreach (Slide::getDisplaysArr() as $type => $display) {
            if (empty($post['slide_image_' . $type]['tmp_name'])) {
                continue;
            }
    ...
    private function getForm(): Form
    {
        ...
        $frm->addRequiredField(Label::getLabel('LBL_Slide_Identifier'), 'slide_identifier');
     ...
     * @return Form
     */
    private function getMediaForm(array $images): Form
    {
