...
class AdminGuestController extends AdminController
{
    ...
    private function getForgotForm()
    {
        ...
        $frm->addEmailField('', 'admin_email', '', ['placeholder' => Label::getLabel('LBL_Enter_Your_Email_Address')])->requirements()->setRequired();
        ...
        $frm->addSubmitButton('', 'btn_forgot', Label::getLabel('LBL_Send_Reset_Pasword_Email'));
        return $frm;
    }
    ...
    private function getResetPasswordForm(int $aId, string $token): Form
    {
        ...
        $fld = $frm->addPasswordField('', 'new_pwd');
