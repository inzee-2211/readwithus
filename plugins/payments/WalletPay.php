...
class WalletPay extends Payment implements PaymentInterface
{
    ...
    public function getChargeData()
    {
        ...
        return [
            ...
            'returnUrl' => MyUtility::makeUrl('Payment', 'return', [$order['order_id']]) . '?txnId=' . $txnId
        ];
    }
    ...
    public function callbackHandler(array $post): array
    {
        ...
        $notifiVar = ['{amount}' => MyUtility::formatMoney(abs($amount)), '{reason}' => Label::getLabel('LBL_WALLET_ORDER_PAYMENT')];
