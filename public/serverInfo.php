...
$text_msql_version = '3. Please make sure you have Mysql version 8.0 or greater than 8.0';
...
$button_back = 'Back';
$memory_limit = getInBytes(ini_get('memory_limit')) >= getInBytes('64M');
...
<head>
    ...
    <style>
        ...
        *,
        ...
        .svg-icn.check svg path,
        .svg-icn.check svg {
            fill: #008000;
        }

        .svg-icn.delete svg path,
        .svg-icn.delete svg {
            fill: #FF0000;
        }
