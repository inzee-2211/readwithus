...
})(jQuery);/* global langLbl, datePickerFormatToDate, FCKeditorAPI, x, CKEDITOR, error, fcom */
...
(function () {
    ...
    checkUniqueErrorNotify = function (caption, value) {
        fcom.error(caption + " '" + value + "' is not available");
    };
})();
