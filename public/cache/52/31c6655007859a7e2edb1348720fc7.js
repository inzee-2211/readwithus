/* global fcom, langLbl, $SalesChartVal, $SalesChartKey, $earningsKey, $earningsVal, $signupsKey, $signupsVal, layoutDirection, $SalesEarningsVal, $affiliateSignupsKey, $productsKey, $SalesEarningsKey, $affiliateSignupsVal, $productsVal */
...
function formAction(frm, callback) {
    if (typeof $(".selectItem--js:checked").val() === 'undefined') {
        fcom.error(langLbl.atleastOneRecord);
        return false;
    }
    $.loader.show();
