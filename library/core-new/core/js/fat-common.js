...
var fcom = {
		...
		ajaxMultipartForm: function(url, frm, fn, options) {
			var o = $.extend(options, {multipart: true});
			this.ajax(url, new FormData(frm), fn, o);
		},
		
		updateWithAjaxMultipartForm: function(url, frm, fn, options) {
			var o = $.extend(options, {multipart: true});
			this.updateWithAjax(url, new FormData(frm), fn, o);
		},
